...
class TCPDFBarcode {
	...
	/**
	 * Calculate CODE 39 checksum (menu 43).
	 * @param $code (string) code to represent.
	...
	/**
	 * Calculate CODE 93 checksum (menu 47).
	 * @param $code (string) code to represent.
	 ...
	 * @param $code (string) code to represent.
	 * @param $checksum (boolean) if true add a checksum to the code (menu 11)
	 * @return array barcode representation.
	 * @protected
	 */
