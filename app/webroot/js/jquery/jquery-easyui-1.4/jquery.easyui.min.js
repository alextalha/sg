 ...
 * 
 * 
 * 11527 ----  inserido span wrap com texto sem spam
 *
 */
(function ($) {
    $.parser = {auto: true, onComplete: function (_1) {
        }, plugins: ["draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "tabs", "accordion", "form"], parse: function (_2) {
            var aa = [];
...
(function ($) {
    ...
    var _849 = $.extend({}, $.fn.datagrid.defaults.view, {render: function (_84a, _84b, _84c) {
        ...
        }, updateRow: function (objeto, id, row) {

            var opts = $.data(objeto, "treegrid").options;
            var dados = $(objeto).treegrid("find", id);
            if( dados === null ){return false;}
            
            $.extend(dados, row);
            var level = $(objeto).treegrid("getLevel", id) - 1;
            var _86c = opts.rowStyler ? opts.rowStyler.call(objeto, dados) : "";
            var _86d = $.data(objeto, "datagrid").rowIdPrefix;
            var idField = dados[opts.idField];
            function _86f(td_oculta) {

                var colunas = $(objeto).treegrid("getColumnFields", id);
                var tr = opts.finder.getTr(objeto, id, "body", (td_oculta ? 1 : 2));
                ...
                $.each(dados, function (index, value) {
                    if (index == 'nome')
                        tr.find('td[field="' + index + '"] .tree-title').text(value);
                    else if (index != 'id')
                        tr.find('td[field="' + index + '"] div').first().text(value);
                });
                /*var tr_content = this.renderRow(objeto,colunas,td_oculta,level,dados);
                 console.log('tr_content='+JSON.stringify(row));
                 console.log(tr);
                 tr.html(tr_content);
                 tr.attr("style",_86c||"");
                 ...
                 if(idField!=id){
                 console.log(idField+'--id:'+id);
                 tr.attr("id",_86d+"-"+(td_oculta?1:2)+"-"+idField);
                 tr.attr("node-id",idField);
                 }*/
            ...
            $(objeto).treegrid("fixRowHeight", id);
