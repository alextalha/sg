 ...
 */
	public function input($fieldName, $options = array(), $fieldTitle=null) {
		...
		$label = $this->_getLabel($fieldName, $options, $fieldTitle);
	...
	public function select($fieldName, $options = array(), $attributes = array()) {
		...
		if (!$id) {
			$attributes['id'] = Inflector::camelize($attributes['id']);
                ...
                $selectItens =  $this->_selectOptions(
		...
		$select = array_merge($select, $selectItens);
 ...
 */
	protected function _selectOptions($elements = array(), $parents = array(), $showParents = null, $attributes = array()) {
		...
		$selectedIsArray = is_array($attributes['value']);
                ...
                if( $attributes['class'] == 'no_reorder' ){}else{
